      ...
      <div className="w-full max-w-2xl glass rounded-2xl p-8 shadow-glow-lg border border-dark-700">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                  <div className="flex items-center">
                    <div className={`w-4 h-4 rounded-full border-2 mr-3 ${
                      ...
                      {selectedPath === path && (
                        <div className="w-full h-full rounded-full bg-primary-500 scale-50"></div>
                      )}
                    </div>
                    <span className={`font-medium ${
                      selectedPath === path ? 'text-primary-300' : 'text-dark-200'
                    }`}>
                      {path}
                    </span>
                  </div>
          ...
          <div>
            ...
            <p className="text-xs text-dark-500 mt-2">Selected: {weeklyHours} hours per week</p>
          </div>
